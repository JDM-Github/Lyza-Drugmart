<header>
    ...
    <nav class="navbar custom-navbar shadow" id="navbar">
        <div class="container">
            ...
            <button class="btn btn-secondary p-2" type="button" data-bs-toggle="offcanvas" data-bs-target="#login-form-offcanvass" aria-controls="login-form-offcanvass">
                <small><i class="bi bi-person-fill"></i>&nbsp;LOG IN</small>
            </button>
        </div>
    </nav>
